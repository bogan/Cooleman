							...
							<table align="left">
								<tr>
									...
									<td align="left" valign="top">
										<h2><font color="#ba7025" face="ARIAL">Animal List</font></h2>
									</td>
									<td width="20">&nbsp;</td>
								</tr>
							</table>
					...
					<tr>		
						<td>	
							<table class="js-dynamitable table table-bordered">
								<thead>
								<tr>
									<th>Group <span class="js-sorter-desc glyphicon glyphicon-chevron-down pull-right"></span> <span class="js-sorter-asc glyphicon glyphicon-chevron-up pull-right"></span> </th>
