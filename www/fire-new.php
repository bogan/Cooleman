...
<p>The history of fire on the ridge has strongly followed the <a href="history-new.php">history</a> of the ridge itself. the role of humans has been the most significant factor in the frequency, intensity and effect of fires on the ridge.</p>
...
<p>
    Fires on the ridge our now actively managed by the <a href="http://www.environment.act.gov.au/ACT-parks-conservation">ACT Parks and Conservation Service</a>.
</p>
...
<p>
    <a href="weeds-new.php">Weeds</a> problem, are not only a major ecological problem but also a major fire management problem.
</p>

<p>
    Weeds are a significant problem in managing fire on the ridge because some weeds are major <span class="highlight">fuel source</span> for fires.

</p>

<p>
    Most <span class="highlight">native grasses</span> on the ridge, in contrast, are much less of a fire hazard.
...
<p>
    The pictures below show Cooleman Ridge before and after the bushfire on 18 January 2003, and the new growth
    brought on by the rains. Those in the second row were taken on 1st February,
    those in the third row in May 2003.
</p>
...
<div class="row">
    <div class="span12">
        ...
        <h3>Regrowth on Cooleman Ridge, March 2003</h3>
