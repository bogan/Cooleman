...
<p>
    Cooleman Ridge has a surprisingly diverse range of flora on it. There are currently over 400 species that have been found on the ridge, with the majority of them being native to the ridge.
</p>

<p>
    The ecology of the ridge, however, has been changed significantly. The flora cover is a mixture of natives and  <a href="weeds-new.php">weeds</a>.
</p>

<!--Revegetation-->
<p>
    The <a href="mission-new.php">mission</a> of the Cooleman Ridge Park Care Group and <a href="strategy-new.php">works</a> to restore the native vegetation of the ridge. The group has cleared many of the better areas of weeds and these areas have show major improvement over approximately 25 year history of the group. In particular, the best areas of the ridge are generally our <a href="group-areas-new.php">Group Areas</a>, but many high quality areas also exist outside of the group areas.
</p>

<!--Surveys-->
<p>
    The group also conducts various surveys that relate to the flora found on the ridge. This include the <a href="plant-survey-new.php">Plant Survey</a>, the <a href="tree-survey-new.php">Tree Survey</a> and the <a href="blackberry-survey-new.php">Blackberry Survey</a>. These surveys serve many purposes from management through to simple interest.
</p>

<p>The following is a list of some of the more common and or easily identified native species found on the ridge. The list intended to provide people who are unfamiliar with the native flora on the ridge a gentle introduction to the dominant native flora found on the ridge. These species are relatively easy to identify, even for a novice. Exotic plants are listed on our <a href="weeds-new.php">weeds</a> page</p>
...
<div class="card card-success">
    <div class="card-header bg-default">Red Box <em>(Eucalyptus polyanthemos)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Yellow Box <em>(Eucalyptus melliodora)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Green Wattle <em>(Acacia Mearnsii)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Silver Wattle <em>(Acacia dealbata)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Spear Grass <em>(Austrostipa scabra)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Weeping Grass <em>(Microlaena stipoides)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Sticky Everlasting <em>(Xerochrysum viscosum)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Australian Bluebell <em>(Wahlenbergia stricta)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Narrawa Burr <em>(Solanum cinereum)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Wild Rasberry <em>(Rubus parvifolius)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Drooping Sheoak <em>(Allocasuarina verticillata)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Blackthorn <em>(Bursaria spinosa ssp lasiophylla)</em></div>
    <div class="card-body">
...
<div class="card card-success">
    <div class="card-header bg-default">Dogwood <em>(Cassinia aculeata)</em></div>
    <div class="card-body">
        ...
        <p>
            The best examples of Dogwood are found on Mt Arawang and in  <a href="group-areas-new.php">Kathner Street Group Area</a>.
        </p>
...
<p>
    ...
    <a href="http://www.threatenedspecies.environment.nsw.gov.au/">The Department of Environment and Conservation has launched</a>. This new website provides detailed information, maps and photos of more than 900 of the state's most vulnerable native plants and animals.</p>

<p>
    <a href="http://plantnet.rbgsyd.nsw.gov.au/">The Plant Information Network System of the Botanic Gardens Trust</a>. Hosts and links to botanical sites. Quote from their web page: "PlantNET can be searched for information on New South Wales plant names, their distribution and conservation status."
</p>

<p>
    <a href="http://plantnet.rbgsyd.nsw.gov.au/floraonline.htm">Flora Online</a>
    - as above.
</p>

<p>
    <a href="http://www.anbg.gov.au/weeds/weeds.html">Australian National
        Botanic Gardens/environmental weeds</a>
</p>
