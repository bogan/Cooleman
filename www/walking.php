...
<div class="col-sm-8">
   ...
   <h2 id="walking">Walking and Running</h2>
    ...
    <h3 id="mtarawangloop">Mt Arawang Loop</h3>
    ...
    <h3 id="coolemanridgereserveloop">Cooleman Ridge Loop</h3>
    ...
    <h3 id="nature-trail">Nature Trail near Kathner St</h3>
    ...
    <h3 id="panorama-walk">Panorama Walk</h3>
...
<div class="col-sm-2">
    <div class="sticky-top">
        <div class="nav flex-column">
            ...
            <a href="#coolemanridgereserveloop" class="nav-link">Cooleman Ridge Loop</a>
            <a href="#nature-trail" class="nav-link">Nature Trail near Kathner St</a>
            <a href="#ridgeline-loop" class="nav-link">The Ridge Line Loop</a>
            <a href="#panorama-walk" class="nav-link">Panorama Walk</a>
            <a href="#cooleman-trig" class="nav-link">Cooleman Trig Trail</a>
        </div>
    </div>
</div>
